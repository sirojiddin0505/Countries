  ...
  <>
    ...
    {openMenu && (
      ...
      <div onClick={() => setOpenMenu(false)}
        className={`fixed top-0 left-0 h-full z-50 transition-transform duration-300 sm:hidden ${openMenu ? "translate-x-0" : "-translate-x-full"}`}>
        <div className="flex gap-4 flex-col max-w-full  bg-gray-900 text-[22px] text-white min-h-screen pt-4 shadow-lg">
          ...
          <div className="flex flex-col gap-5 px-10 py-4">
            ...
            <NavLink to="/about">About</NavLink>
            <NavLink to="/hero">Contact</NavLink>
            <button className="flex border w-[160px] cursor-pointer border-white/50 p-2 rounded-md hover:bg-gray-800 bg-gray-900 text-white">
              Qayta yuklash
            </button>
            <button className="flex items-center w-[170px] gap-1 py-2 px-4 rounded-lg shadow-sm cursor-pointer text-black bg-white">
              Light Mode <GoSun />
            </button>
            <div></div>
          </div>
